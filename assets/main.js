...
tl.to("#desc01, #desc02, #desc03, #desc04",{duration:1.5,width:"110px",height:"110px", fontSize:"0.51em", paddingTop:"5.5%" ,marginTop:"0",marginBotom:"0",textAlign:"center",x:"1em",y:"0.3em",borderRadius:120,color:"#fff",backgroundColor:"#5dad7eff",ease:"back",stagger:0.2});
...
tl.from(".confirmbuttoncontainer",{duration:5, x:"100vw",rotation:3600,ease:"power4"},"-=4");